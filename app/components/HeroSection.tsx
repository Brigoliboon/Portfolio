	...
	return (
		<section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden py-16 sm:py-20">
			...
			<div className="container mx-auto px-4 z-10">
				...
				{/* Activity Statistics */}
				<div className='max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-2 gap-3 sm:gap-4 mb-12 px-2'>
					<div className='flex flex-col'>
						<h1 className='text-3xl mb-1 text-center'>Satistics Card</h1>
						<img className='h-52' src="https://github-readme-stats.vercel.app/api?username=brigoliboon&show_icons=true&include_all_commits=true&rank_icon=github&theme=tokyonight" />
					</div>
					<div className='flex flex-col justify-center align-center'>
						<h1 className='text-3xl mb-1 text-center'>Languages</h1>
						<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Brigoliboon&layout=compact&theme=tokyonight" />
					</div>
				...
				<a href="http://bio-vision-api.vercel.app/">
							...
							<div className="relative p-8">
								...
								<div className="text-center mt-6">
									...
									<div className="flex flex-wrap justify-center gap-2">
										{['Machine Learning', 'Plant analysis', 'Health Diagnosis'].map((feature, index) => (
											<span
												key={index}
