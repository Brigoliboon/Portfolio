			...
			<div className="max-w-4xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-8">
					<h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
						Let&apos;s Create Amazing Application Experiences
					</h2>
					<p className="text-gray-400 max-w-2xl mx-auto">
						Ready to bring your application idea to life? I specialize in creating polished, user-friendly applications that deliver exceptional
						experiences.
					</p>
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:brigoliboonjefferson@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/Brigoliboon"
							target="_blank"
